function verificar(){
    ...
    if (nascimento.value > ano || nascimento.value <= 1900){
        ...
        if (idade >= 0 && idade < 10){
            imagem.src = `../img/crianca_${gênero}.png`;
        } else if (idade >= 10 && idade < 20){
            imagem.src = `../img/adolescente_${gênero}.png`;
        } else if (idade >= 20 && idade < 30){
            imagem.src = `../img/jovem_${gênero}.png`;
        } else if (idade >= 30 && idade < 50){
            imagem.src = `../img/adulto_${gênero}.png`;
        } else if (idade >= 50){
            imagem.src = `../img/idoso_${gênero}.png`;
        }
    }
}